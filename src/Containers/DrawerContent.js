...
class DrawerContent extends Component {
	...
	render() {
        ...
        <View style={styles.header}><Image source={Images.logo} style={styles.logo} /></View>
				...
				<Footer style={styles.callus}>
					...
					<Text style={{ paddingLeft: 15 }} onPress={()=> this.callNumber(`tel:+79619974245`)}>Позвоните нам</Text>
				</Footer>
			</View>
		);
	}
